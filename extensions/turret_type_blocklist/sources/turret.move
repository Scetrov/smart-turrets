/// Turret strategy that permanently excludes hard-coded ship type ids.
///
/// This seed uses a fixed in-source blocklist. Changing the blocked ids requires editing and
...
const BLOCKED_TYPE_ID_A: u64 = 31;
const BLOCKED_TYPE_ID_B: u64 = 237;
...
public(package) fun build_priority_list_for_owner(
    ...
    let blocked_type_ids = blocked_type_ids();
